...
describe("Redundancy Module - Integration Tests", () => {
  ...
  test("should not duplicate output when similar content is processed twice", () => {
...
SimilarityThreshold: 70`,
  ...
  test("should not merge distinct sequential AI outputs", () => {
    const initialHistory: History[] = [
...
SimilarityThreshold: 70`,
  ...
  test("should merge when AI produces legitimately overlapping content", () => {
    const initialHistory: History[] = [
...
SimilarityThreshold: 70`,
  ...
  test("should find correct last AI message with player actions in between", () => {
    ...
    (globalThis as any).history = historyWithPlayerActions;
...
SimilarityThreshold: 70`,
  ...
  test("should handle case where no previous AI output exists", () => {
    const historyWithoutAI: History[] = [
      { text: "You start your adventure.", type: "start" },
      { text: "You look around.", type: "do" },
    ];
    (globalThis as any).history = historyWithoutAI;
...
SimilarityThreshold: 70`,
  ...
  test("should not merge when module is disabled", () => {
    const initialHistory: History[] = [
      { text: "You enter the room.", type: "do" },
...
SimilarityThreshold: 70`,
  ...
  test("should not merge similar sentence structures with different meaning", () => {
    const initialHistory: History[] = [
...
SimilarityThreshold: 70`,
  ...
  test("should not merge when sentences share common words but different context", () => {
    const initialHistory: History[] = [
      { text: "You approach the door.", type: "do" },
      {
...
SimilarityThreshold: 70`,
  ...
  test("should handle case where previous output ends with sentence that looks similar to new output start", () => {
    const initialHistory: History[] = [
...
SimilarityThreshold: 70`,
  ...
  test("should not merge distinct sequential sentences that share a character name (real scenario)", () => {
    const initialHistory: History[] = [
      {
